    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="{{route('indexAdmin')}}" class="logo"><img src={{asset("assetAdmin/images/logo1.png")}} alt="" />
                </a>
            </div>
            <!--== SEARCH ==-->
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                <!-- Dropdown Trigger -->
                <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'><img src={{asset("assetAdmin/images/user/6.png")}} alt="" />Compte <i class="fa fa-angle-down" aria-hidden="true"></i>
                </a>
                ...
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    ...
                    <li class="divider"></li>
                    <li><a href="#" class="ho-dr-con-last waves-effect"><i class="fa fa-sign-in" aria-hidden="true"></i> Deconnexion</a>
                    </li>
                </ul>
            </div>
        </div>
